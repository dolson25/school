...
(define from-ptr 'uninitialized-heap-ptr)
(define to-ptr 'uninitialized-heap-ptr)
 
(define (init-allocator)
 (set! heap-ptr 0)
 (set! from-ptr 0)
 (set! to-ptr (/ (heap-size) 2)))


(define (copy) (print 3))
  ;if 0 is a prim, if cons...
  ;get root set?

  ;copy the next spot in heap


 
(define (gc:alloc-flat p)
 (begin
   (when (> (+ heap-ptr 2) to-ptr)
     (copy))
